    ...
    IRequestHandler<CreateAttendanceRegularizationCommand, Result<string>>
{
    public async Task<Result<string>> Handle(CreateAttendanceRegularizationCommand request, CancellationToken cancellationToken)
    {
        ...
        new SqlParameter("@RegularizationFor", (object?)request.regularization.RegularizationFor ?? DBNull.Value),
        new SqlParameter("@ActualInTime", (object?)request.regularization.ActualInTime ?? DBNull.Value),
        new SqlParameter("@ActualOutTime", (object?)request.regularization.ActualOutTime ?? DBNull.Value),
