...
public static class CandidateMapper
{
    public static Candidate ToDomain(this Entity entity)
    {
        return new Candidate(
            ...
            entity.IsInterviewLetterRecieved,
            entity.IsOfferLetterReceived,
            entity.IsAppointmentLetterReceived,
            entity.IsWelcomeLetterRecieved,
            entity.WrittenInterviewFile,
            entity.SignedJoiningLetterFile,
            entity.CreatedBy,
            entity.CreatedOn,
            entity.ModifiedBy,
            entity.ModifiedOn);
    ...
    public static Entity ToEntity(this Candidate candidate)
    {
        return new Entity
        {
            ...
            IsInterviewLetterRecieved = candidate.IsInterviewLetterRecieved,
            IsOfferLetterReceived = candidate.IsOfferLetterReceived,
            IsAppointmentLetterReceived = candidate.IsAppointmentLetterReceived,
            IsWelcomeLetterRecieved = candidate.IsWelcomeLetterRecieved,
            WrittenInterviewFile = candidate.WrittenInterviewFile,
            SignedJoiningLetterFile = candidate.SignedJoiningLetterFile,
